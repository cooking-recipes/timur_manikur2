...
public function download() {
	  ...
	  if (isset($this->request->get['modification_id'])){
		$oc_mod = $this->model_extension_modification->getModification($this->request->get['modification_id']);
		$this->response->addHeader('Content-Description: File Transfer');
		$this->response->addHeader('Content-Type: application/octet-stream');
		$this->response->addHeader('Content-Disposition: attachment; filename=' . basename($oc_mod['code']) . '.xml');
		$this->response->addHeader('Content-Transfer-Encoding: binary');
		$this->response->setOutput($oc_mod['xml']);
	  }
	  }
